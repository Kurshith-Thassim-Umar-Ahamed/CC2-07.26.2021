        ...
        <div class="form-signin">
            <form>
                ...
                <div class="form-floating">
                    <input type="name" class="form-control" id="floatingInput" placeholder="Enter Name">
                ...
                <div class="form-floating">
                    <input type="number" class="form-control" id="floatingInput" placeholder="Telephone number">
                    <label for="floatingInput">Enter Telephone Number</label>
                </div>

                <div class="login-register-submit-button">
                <button class="w-100 btn btn-lg btn-success" type="submit">Sign up as customer</button>
                
            </div>
            <div class="registerRestaurant-button">
                <button class="w-100 btn btn-lg btn btn-outline-warning" type="submit">Sign up as Restaurant</button>
            </div>
